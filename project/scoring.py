...
CATEGORY_SCORES = {
    "urgent_safety": 10, "animal_welfare": 7, "health": 6, "care": 5,
    "pet_news": 4, "evergreen_cat_fact": 5, "evergreen_pet_care": 5,
    "evergreen_adoption_story": 6, "evergreen_breed": 4,
}
SIGNAL_SCORES = {"official": 2, "seasonal": 2, "practical": 2}
SPECIES_SCORES = {"cats": 2, "dogs": 1, "small_pets": 1}
...
def calculate_score(news_item, now=None):
    ...
    elif category in {"animal_welfare", "health"}:
